...
<div class='ankieta'>
Zachęcamy do udziału w ankiecie o naszej stronie internetowej: <a class="link2" href="https://goo.gl/forms/rqZOWjAGZy3arEpH3" target="_blank">Link do ankiety</a>
</div>
...
$system = $ua_info['platform'];
	...
	echo"<script>screen.width+'x'+screen.height</script>" ;
	
	
	
$sql = mysqli_query ($connection, "INSERT INTO logi_goscie (ip,region,panstwo,miasto,lokalizacja,przegladarka,system_operacyjny,rozdzielczosc ) VALUES ('$ip','$region','$country','$city','$loc','$przegladarka','$system','$rodzielczosc') ") 
